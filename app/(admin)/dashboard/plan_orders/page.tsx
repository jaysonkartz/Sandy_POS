...
import { fetchPlanOrders } from "@/app/lib/data";
import Table from "@/app/ui/plan_orders/table";
...
const FETCH_DATA = fetchPlanOrders;
    ...
    <main>
      <div className="w-full">
        ...
        <div className="mt-4 flex items-center justify-between gap-2 md:mt-8">
          <Search placeholder="Search plan orders..." />
          <CreateEntity
