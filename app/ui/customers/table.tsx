...
import { FormattedCustomersTable2 } from "@/app/lib/definitions";
...
export default async function CustomersTable({
  ...
  agedDate.setDate(agedDate.getDate() - 30);
                ...
                <tbody className="divide-y divide-gray-200 text-gray-900">
                  {customers.map((customer) => (
                    <tr key={customer.id} className="group">
                      ...
                      <td
                        className={
                          customer.pending_invoices == 0
                            ...
                            : "whitespace-nowrap bg-yellow-300 px-4 py-5 text-sm"
                        }
                      >
                      ...
                      <td
                        className={
                          customer.total_pending == formatCurrency(0)
                            ? "whitespace-nowrap bg-white px-4 py-5 text-sm"
                            : "whitespace-nowrap bg-yellow-300 px-4 py-5 text-sm"
                        }
                      >
                      ...
                      >
                        {formatDateToLocal(customer.oldest_unpaid_invoice_date)}
                      </td>
                    </tr>
                  ))}
                </tbody>
