...
describe("CategoryFilter", () => {
  it("should render all categories option", () => {
    ...
    render(
      <CategoryFilter isEnglish={true} selectedCategory="all" onCategoryChange={onCategoryChange} />
    );
  ...
  it("should have correct selected value", () => {
    const onCategoryChange = vi.fn();
    render(
      <CategoryFilter isEnglish={true} selectedCategory="1" onCategoryChange={onCategoryChange} />
    );
