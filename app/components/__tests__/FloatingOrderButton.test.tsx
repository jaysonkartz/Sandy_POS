...
describe("FloatingOrderButton", () => {
  it("should render with correct text in English", () => {
    const onClick = vi.fn();
    render(<FloatingOrderButton isEnglish={true} selectedProductsCount={5} onClick={onClick} />);
  ...
  it("should render with correct text in Chinese", () => {
    const onClick = vi.fn();
    render(<FloatingOrderButton isEnglish={false} selectedProductsCount={3} onClick={onClick} />);
  ...
  it("should call onClick when clicked", () => {
    const onClick = vi.fn();
    render(<FloatingOrderButton isEnglish={true} selectedProductsCount={3} onClick={onClick} />);
  ...
  it("should have correct styling classes", () => {
    ...
    const { container } = render(
      <FloatingOrderButton isEnglish={true} selectedProductsCount={1} onClick={onClick} />
    );
