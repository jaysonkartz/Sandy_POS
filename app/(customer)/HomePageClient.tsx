...
import ProductPhotoEditor from "@/app/components/ProductPhotoEditor";
...
import type { Product, SelectedOptions } from "@/app/types/product";
...
export default function HomePageClient({ initialProducts }: { initialProducts?: Product[] }) {
  ...
  const productOptions = initialProducts !== undefined ? { initialProducts } : undefined;
  ...
  const {
    ...
    handleSearchChange,
    handleClearSearch,
  } = useProducts(selectedCategory, isEnglish, session, productOptions);
